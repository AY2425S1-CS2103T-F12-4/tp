...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. One or more of the inputted parameters, or the command, is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. VBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The name of the requested person is the same as an existing person in the addressbook.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. VBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Edit a person's details")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. VBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. One or more of the inputted parameters, or the command, is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. VBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("3c. The name of the requested person is the same as an existing person in the addressbook.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3c1. VBook shows an error message.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: Find persons matching criteria")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: Export data")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to export data.")]),_v(" "),_c('li',[_v("VBook opens the file explorer window.")]),_v(" "),_c('li',[_v("User chooses the destination and name of the exported data.")]),_v(" "),_c('li',[_v("VBook exports the data to the destination folder in JSON format.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. User closes the file explorer window without selecting a destination.\nUse case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The name of the exported data clashes with an existing name in the same file destination.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. The file explorer displays an error message.\nUse case returns to step 2.")])])]),_v(" "),_c('li',[_c('p',[_v("3b. The user enters an invalid name.")]),_v(" "),_c('ul',[_c('li',[_v("3b1. The file explorer displaus an error message.\nUse case returns to step 2.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Enter password")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User starts the app.")]),_v(" "),_c('li',[_v("VBook displays a window prompting the user to enter a password.")]),_v(" "),_c('li',[_v("User enters the correct password.")]),_v(" "),_c('li',[_v("VBook closes the password prompt window and opens the main app window.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("2a. User enters the wrong password.\n"),_c('ul',[_c('li',[_v("2a1. VBook displays an error message.\nUse case returns to step 2.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Undo command")]),_v(" "),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to undo the last command.")]),_v(" "),_c('li',[_v("VBook undoes the last change to the data.")]),_v(" "),_c('li',[_v("Use case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. There is no previously done add/edit/delete command found.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. VBook displays a message that there are no more commands to undo.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. User has undone more commands than the maximum amount allowed.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. VBook displays a message that there are no more commands to undo.\nUse case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Redo command")]),_v(" "),_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to redo the last undone command.")]),_v(" "),_c('li',[_v("VBook redoes the last undone command.\nUse case ends.\n"),_c('strong',[_v("Extensions")])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. There is no previously undone command.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. VBook displays a message that there are no more commands to redo.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("1b. User has redone more commands than the maximum amount allowed.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. VBook displays a message that there are no more commands to redo.\nUse case ends.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Dealing with missing data files")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: There is an existing data/vbook.json file in the home folder of the .jar file.")])]),_v(" "),_c('li',[_c('p',[_v("Delete the data/vbook.json file. Close the address book and open it again.")]),_v(" "),_c('p',[_v("Expected: The data is replaced with the sample data that shows when the app is first open.")])])])])])}
},function anonymous(
) {
